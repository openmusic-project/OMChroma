...
;	LPBEG	: initial starting loop point [sec] (0.0)
;	LPEND	: initial ending loop point [sec] (0.2)
;	WIN 	: initial crossfade length [sec] (0.1)
;	LPBEG1	: final starting loop point [sec] (0.3)
;	LPEND1	: final ending loop point [sec] (0.5)
;	WIN1 	: final crossfade length [sec] (0.1)
;	MODE	: loop mode [0=fwd, 1=bkwd, 2=fwd+bkwd] (0)
;*****************************************************************************

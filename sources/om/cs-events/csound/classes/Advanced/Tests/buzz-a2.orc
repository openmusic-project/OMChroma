...
;	F0	:	min fundamental frequency [Hz] (220.0)
;	F0DEV	:	max fundamental frequency [Hz] (440.0)
;	F0ENV	:	fundamental frequency envelope [GEN] (asc. line)
;	AENV	:	function number for the amplitude envelope [GEN] (triangle)
;	BZL	:	lowest harmonic present in the buzz [Hz] (100.0)
;	BZH	:	highest possible harmonic present [Hz] (4000.0)
...
; amp envelope
   ...
   asnd    gbuzz   kenv,kf0,(sr/2/kf0)*ihh,(ilh/kf0),kmul,ifn

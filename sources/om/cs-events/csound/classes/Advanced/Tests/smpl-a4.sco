...
; SAME AS SMPL-a#.ORC, BUT WITH RELATIVE STARTING AND LOOP POINTS
;=============================================================================
...
; straight mn/mx, 10", from mid, tgl fenv, no jit, straight aenv, win = 0.0
i1 0 5 0.0 1.0 2.0 7 0.0 2.0 0.0	31	0.5	8	0.0
s 6
; octave down (bkwrds), 10", from end, no jit, straight aenv, win = 0.0
i1 0 5 0.0 -0.5 -0.5 7 0.0 2.0 0.0	31	1.0	8	0.0
s 6

; vibrato, amp=-6dB, no jit, from 10%
i1 0 10 -6 0.95 1.05 5	0.0 0.2	0.0	31	0.1	7	0.0
s 11

; idem, very strong, from 20%
i1 0 10 0.0 0.5 2.0 5 	0.0 0.2 0.0	31	0.2	7	0.01
s 11

; idem, very strong, bckwds, from 90%
i1 0 10 0.0 -5.0 -0.5 6 0.1 10.0 0.2	31	0.9	8	0.01
e
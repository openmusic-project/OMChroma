...
(setf ms-test-list '(10 20 30))
(attach 'a '(1 2 3))
(attach 'aa ms-test-list)
ms-test-list
...
(setf ms-test-str (make_tbl '(0 0 1 1)))
(setf ms-test-fun (make_fun '(0 0  1 1  0 2)))
(is_fun ms-test-str)
(is_tbl ms-test-str)
(pls-check-type 'tbl ms-test-str 'ms-test-fun)
;error
;(pls-check-type 'fun ms-test-str 'ms-test-fun)
...
;rplac
;(defun rplac (l s1 s2)
(setf ms-test-list '(a b c))
(rplac ms-test-list 1 '(2 3 a))
...
(setf ms-test-cwt (build-cwt 'wt-a1 '(wt-a2 0 1) '(wt-a3 (att_wt wt-a3) '(dur_wt wt-a3))))
...
|#
(setf ms-test-tbl (make_tbl '(a 1 b 2)))
(setf ms-test-tbl1 (make_tbl))
(is-empty ms-test-tbl)
(is-empty ms-test-tbl1)
...
;	SOURCE:		$PLSsys/allpurp.ll"
|#
(setf ms-test-ctl (make_ctl '(a 1) '(b 2) '(c 3)))
(sizeof ms-test-ctl)
...
;	SOURCE:		$PLSsys/allpurp.ll"
|#
(short-prnt ms-test-ctl)
(short-prnt ms-test-fun)
;-----------------------------------------------------------------------------
...
(setf ms-test-type (attach-type 'RAW '(1 2 3)))
...
(pls-type ms-test-type)
(pls-type ms-test-fun)

(contents ms-test-type)
(contents ms-test-fun)
(contents ms-test-ctl)
...
(is-tagged 'a)
(is-tagged '(a))
(is-tagged ms-test-fun)
(is-tagged ms-test-ctl)
...
(setf ms-test-tbl0 (make_tbl))
(setf ms-test-tbl1 (make_tbl 'a))
(setf ms-test-tbl2 (make_tbl 'a 10))
(setf ms-test-tbl3 (make_tbl 'a 'b 21))
...
;(lookup_tbl ms-test-tbl0 'a)
(lookup_tbl ms-test-tbl1 'a)
(lookup_tbl ms-test-tbl2 'a)
;(lookup_tbl ms-test-tbl3 'a)
(lookup_tbl ms-test-tbl3 'a 'b)
...
(soft-lkp_tbl ms-test-tbl0 'a)
(soft-lkp_tbl ms-test-tbl1 'a)
(soft-lkp_tbl ms-test-tbl2 'a)
(soft-lkp_tbl ms-test-tbl3 'a)
(soft-lkp_tbl ms-test-tbl3 'a 'b)
...
(lkeys_tbl ms-test-tbl0)
(lels_tbl ms-test-tbl0)
(lkeys_tbl ms-test-tbl1)
(lels_tbl ms-test-tbl1)
(lkeys_tbl ms-test-tbl2)
(lels_tbl ms-test-tbl2)
(lkeys_tbl ms-test-tbl3)
(lels_tbl ms-test-tbl3)
...
(setf ms-test-tbl4 (copy-list ms-test-tbl3))
(insert_tbl ms-test-tbl4 'bb 'bb1 222)
(insert_tbl ms-test-tbl4 'aa 111)
(insert_tbl ms-test-tbl4 'cc)
(insert_tbl ms-test-tbl4 'dd 'dd1 335)
(insert_tbl ms-test-tbl4 'ee 'ee1 '(this is my list))
(lkeys_tbl ms-test-tbl4)
(lels_tbl ms-test-tbl4)
ms-test-tbl4
(rm_tbl ms-test-tbl4 'dd 'dd1)
(lkeys_tbl ms-test-tbl4)
(lels_tbl ms-test-tbl4)

(assoc 'aa (contents ms-test-tbl4))

;(rm_tbl ms-test-tbl4 'g)
...
;	SOURCE:		$LLsys/tbl.ll
(merge_tbl ms-test-tbl0 ms-test-tbl1)
(merge_tbl ms-test-tbl1 ms-test-tbl2)
(merge_tbl ms-test-tbl2 ms-test-tbl3)
(setf ms-test-ttbl1 (merge_tbl ms-test-tbl0 ms-test-tbl1 ms-test-tbl2 ms-test-tbl3 ms-test-tbl4))
(lkeys_tbl ms-test-ttbl1)
(lels_tbl ms-test-ttbl1)
...
(is-key_tbl ms-test-ttbl1 'a)
(is-key_tbl ms-test-ttbl1 'a 'b)
(is-key_tbl ms-test-ttbl1 'k)
...
(is-empty_tbl ms-test-tbl0)
(is-empty_tbl ms-test-ttbl1)
...
(sizeof_tbl ms-test-tbl4)
(sizeof_tbl ms-test-ttbl1)
(sizeof-all_tbl ms-test-ttbl1)
...
;	VALUE:		the string 'done
;	SOURCE:		$LLsys/tbl.ll
(print_tbl ms-test-ttbl1)
(print_tbl ms-test-tbl4)

(short-print_tbl ms-test-ttbl1)
(short-print_tbl ms-test-tbl4)
;-----------------------------------------------------------------------------
...
(setf ms-test-ctl (make_ctl '(a 10) '(b 20) '(c (30 31 32)) '(d 40)))
...
(get_ctl ms-test-ctl 'v)
(get_ctl ms-test-ctl 'c)
...
(set_ctl ms-test-ctl 'v 1000)
(set_ctl ms-test-ctl 'b 2222)
(prnt ms-test-ctl)
(rm_ctl ms-test-ctl 'h)
(rm_ctl ms-test-ctl 'v)
...
(is-key_ctl ms-test-ctl 'v)
(is-key_ctl ms-test-ctl 'c)
...
(is-empty_ctl ms-test-ctl)
(setf ms-test-ctl0 (make_ctl))
(is-empty_ctl ms-test-ctl0)
...
(print_ctl ms-test-ctl)
(short-print_ctl ms-test-ctl)
;-----------------------------------------------------------------------------
...
(setf ms-test-raw (make_raw 0 1 2))
(contents ms-test-raw)
...
(print_raw ms-test-raw)
(short-print_raw ms-test-raw)
;-----------------------------------------------------------------------------
...
(setf ms-test-fun (make_fun '(0 0  100.0 10.0  20.0 20.0  70.0 40.0   0 100.0)))
...
(sample_fun ms-test-fun 101)
(sample_fun ms-test-fun 101 1.0)
...
(x-beg_fun ms-test-fun)
(x-end_fun ms-test-fun)
(y-beg_fun ms-test-fun)
(y-end_fun ms-test-fun)
...
;	VALUE:		the values described above
;	SOURCE:		$LLpls/fun.ll
(y-min_fun ms-test-fun)
(y-max_fun ms-test-fun)
...
;	VALUE:		the values described above
;	SOURCE:		$LLpls/fun.ll
(y-list_fun ms-test-fun)
(x-list_fun ms-test-fun)
...
;	VALUE:		the string 'ok
;	SOURCE:		$LLpls/fun.ll
(setf ms-test-fun1 (copy-list ms-test-fun))
(resc_fun ms-test-fun1 -100.0 1000.0 10.0 20.0)
(x-resc_fun ms-test-fun1 -1000.0 1000.0)
(y-resc_fun ms-test-fun1 -500.0 500.0)
;-----------------------------------------------------------------------------
#|
...
|#
(setf ms-test-fun2 (sample_fun ms-test-fun 101))
(reduce_fun ms-test-fun2 0.02)
...
(print_fun ms-test-fun)
(short-print_fun ms-test-fun)
;-----------------------------------------------------------------------------
...
"
|#
(setf ms-test-ve (make_ve (make_fun '(0 0  10 1  0.5  30)) 1000))
(setf ms-test-ve0 (make_ve (make_fun '(0 0  10 1  0.5  30))))
...
; MAKE_WT
;(setf ms-test-wt (make_wt (merge-pathnames (get-cr-path :wt) "wt-tpt.aif")))
(setf ms-test-wt (make_wt "wt-tpt.aif" (get-cr-path :wt)))
(setf ms-test-wt1 (make_wt "wt-tpt.aif" (get-cr-path :wt)))
(reinit_wt ms-test-wt1 "ms-test-sopr1.aif" (get-cr-path :wt))
ms-test-wt1
(reinit_wt ms-test-wt1 "wt-sopr1.aif" (get-cr-path :wt))
ms-test-wt1
;             (get-sndinfo (merge-pathnames (get-cr-path :wt) "wt-tpt.aif"))
;(disable-print)
(add-field_wt ms-test-wt1 'TESTFIELD 111.0)
(rm-field_wt ms-test-wt1 'TESTFIELD)
...
(file-name_wt ms-test-wt)
(set-file-name_wt ms-test-wt "test")
(set-file-name_wt ms-test-wt "wt-tpt.aif")

(dir_wt ms-test-wt)
(set-dir_wt ms-test-wt "test-dir")
(set-dir_wt ms-test-wt (get-cr-path :wt))
...
(freq_wt ms-test-wt)
(set-freq_wt ms-test-wt 207.9)
(set-freq_wt ms-test-wt 1.5 'si)
(set-freq_wt ms-test-wt 30.0 'si)
(set-si_wt ms-test-wt 15.0)
(set-freq_wt ms-test-wt 207.9)
;(set-freq_wt ms-test-wt 15.0 'ss)
...
(flt_wt ms-test-wt)
(set-flt_wt ms-test-wt 1000.0)
(flt_wt ms-test-wt)

(fade_wt ms-test-wt)

(set-fade_wt ms-test-wt '(0.005 0.01))
(fade_wt ms-test-wt)
(set-fade_wt ms-test-wt 0.11)
(fade_wt ms-test-wt)
(set-fade_wt ms-test-wt '(0.0055))
;(set-fade_wt ms-test-wt 's)
(fade_wt ms-test-wt)
...
(beg-off_wt ms-test-wt)
(set-beg-off_wt ms-test-wt 1.0 0.5)
(set-beg-off_wt ms-test-wt 1.0)
;(set-beg-off_wt ms-test-wt 10.0)
;(set-phys-dur-att_wt ms-test-wt 0.5)
;-----------------------------------------------------------------------------
...
(end-off_wt ms-test-wt)
(end-off_wt ms-test-wt 2.0) ; TWICE AS SHORT

(set-end-off_wt ms-test-wt 7.322)
;(set-end-off_wt ms-test-wt 0.5)
;(set-beg-off_wt ms-test-wt 10.0)
...
(set-dur-att_wt ms-test-wt 0.2)
(dur-att_wt ms-test-wt)
(phys-dur-att_wt ms-test-wt)
;(disable-print)
(enable-print)
;(set-phys-dur-att_wt ms-test-wt 0.3)
(dur-att_wt ms-test-wt)
(set-dur-att_wt ms-test-wt 0.3)

;-----------------------------------------------------------------------------
; VAR-ATT: RETURN/SET THE RANDOM VARIATION THAT WILL BE APPLIED WHEN
;    COMPUTING THE ATTACK PORTION OF THE SOUND FILE
(set-var-att_wt ms-test-wt 0.1)
(var-att_wt ms-test-wt)
...
(set-win-from_wt ms-test-wt 2.0)
(win-from_wt ms-test-wt)
(win-phys-from_wt ms-test-wt)
(set-win-phys-from_wt ms-test-wt 0.5) ; set it automatically to beg-off
(win-from_wt ms-test-wt)
(set-win-from_wt ms-test-wt 0.1)

(win-size_wt ms-test-wt)
(win-to_wt ms-test-wt)
...
(enable-print)
(win-size_wt ms-test-wt)
(win-min-size_wt ms-test-wt)
(set-win-size_wt ms-test-wt 0.001)
(set-win-size_wt ms-test-wt 2.0)

(set-win-size_wt ms-test-wt 12.0)
(win-from_wt ms-test-wt)
(dur_wt ms-test-wt)
(beg-off_wt ms-test-wt)
(end-off_wt ms-test-wt)
(set-win-from_wt ms-test-wt 1.0)
(set-win-size_wt ms-test-wt 6.0)
(win-from_wt ms-test-wt)
(dur_wt ms-test-wt)
(beyond-eof_wt ms-test-wt 7.0)
(beyond-eof_wt ms-test-wt 8.0)

(set-win_wt ms-test-wt 1.0 3.0)
(win-from_wt ms-test-wt)
(win-size_wt ms-test-wt)
;(set-win_wt ms-test-wt 4.0 3.0)
(set-win_wt ms-test-wt 1.0 1.0001)
(win-size_wt ms-test-wt)

;(set-win_wt ms-test-wt 10.0 11.0)
;(set-win_wt ms-test-wt -1.0 1.0)
;(win-from_wt ms-test-wt)

(phys-win_wt ms-test-wt)
(win_wt ms-test-wt)

;-----------------------------------------------------------------------------
; WIN-[PHYS-]TO: RETURN THE END POINT OF A WINDOW
(set-win-to_wt ms-test-wt 3.0)
(win-to_wt ms-test-wt)

(set-win-phys-to_wt ms-test-wt 3.0)
(win-phys-to_wt ms-test-wt)

(set-win-phys-to_wt ms-test-wt 0.0)
(win-phys-to_wt ms-test-wt)

(set-win-phys-to_wt ms-test-wt 10.0)
(win-phys-to_wt ms-test-wt)
...
(phys-dur_wt ms-test-wt)
(set-phys-dur_wt ms-test-wt (merge-pathnames *cr-wt-dir* "wt-sopr1.aif") )
(phys-dur_wt ms-test-wt)
;(set-end-off_wt ms-test-wt 4.0)
(end-off_wt ms-test-wt)
(set-phys-dur_wt ms-test-wt (merge-pathnames *cr-wt-dir* "wt-tpt.aif") )
(phys-dur_wt ms-test-wt)
...
(abs-file_wt ms-test-wt)

; NTH-FREQ: RETURN THE NTH FREQUENCY OF A LIST
(nth-freq_wt ms-test-wt)
(nth-freq_wt ms-test-wt 3)
(set-freq_wt ms-test-wt '(200 300 400 500))
(nth-freq_wt ms-test-wt 4)
...
(first-freq_wt ms-test-wt)
(ran-freq_wt ms-test-wt)
(last-freq_wt ms-test-wt)
...
(close-freq_wt ms-test-wt 11.0)
(close-freq_wt ms-test-wt 211.0)
(close-freq_wt ms-test-wt 251.0)
(close-freq_wt ms-test-wt 900.0)
(close-freq_wt ms-test-wt 470.0)
;-----------------------------------------------------------------------------
; FIELD: GET THE VALUE OF A DYNAMICAL FIELD
(field_wt ms-test-wt '(off beg))
(field_wt ms-test-wt '(beg off)) ; unexistent, wrong order

(set-field_wt ms-test-wt '(off beg) 2.2)
(set-field_wt ms-test-wt '(beg off) 2.2)
(set-field_wt ms-test-wt 'fade-env 2.4)


;-----------------------------------------------------------------------------
; DUR: RETURN THE PERCEPTUAL DURATION (TIME GAP BETWEEN BEG-OFF AND END-OFF)
(dur_wt ms-test-wt)
(dur_wt ms-test-wt 2.0)

;-----------------------------------------------------------------------------
; [PHYS-]ATT: RETURN THE REAL ATTACK, IE THE ATTACK INCLUDING THE
;	RANDOM VARIATION
(att_wt ms-test-wt)
(phys-att_wt ms-test-wt)
...
(n-ch_wt ms-test-wt)
(sr_wt ms-test-wt)
(pk-mode_wt ms-test-wt)
(n-smpls_wt ms-test-wt)
...
(is-si_wt ms-test-wt)
(is-field_wt ms-test-wt '(off beg))
(is-field_wt ms-test-wt 'fade-env)
...
;   (let ((ovlp (* (dur_wt (curr_wt) (ms-test-si_wt)) 0.1)) )
...
; In this latter case, the function (ms-test-si_wt) is to be used. It means that
...
;    (curr_wt), its sample increment (ms-test-si_wt), computed after all the
;    modifications, its added control structure (see above) (ms-test-lco_wt) and
...
;    (ms-test-trel_wt, ms-test-tnorm_wt).
...
(set-frz_wt ms-test-wt ms-test-frz1 ms-test-frz2)
...
(frz-mode_wt ms-test-wt)
(set-frz-mode_wt ms-test-wt 0)
(frz-mode_wt ms-test-wt)
...
;FIRST-FRZ_WT
(first-frz_wt ms-test-wt)
(last-frz_wt ms-test-wt)
(nth-frz_wt ms-test-wt 0)
(nth-frz_wt ms-test-wt 3)
...
;	SOURCE:		$LLpls/wt-frz.ll
(frz-field_wt (first-frz_wt ms-test-wt) 'inc-pt)

(cassq 'inc-pt (eval(last-frz_wt ms-test-wt))))
...
;-----------------------------------------------------------------------------
; from "code/projects/omsounds/tool/utils-from-chroma.lisp"
;-----------------------------------------------------------------------------
;******************************************************************
;-------| CHROMA SYSTEM

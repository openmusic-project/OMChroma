...
; @PARAM 3 "durs" number 1.0 "durations [sec]"
; @PARAM 4 "amp" number -6.0 "maximum amplitude [linear (0.0,1000.0) or dB (-INF,0.0)]"
; @PARAM 5 "freq" number 440.0 "frequency [Hz]"
; @PARAM 6 "atk" number 0.01 "decay time [sec]"
; @PARAM 7 "dec" number 0.05 "frequency [Hz]"
; @PARAM 8 "aenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (32768 1) (65536 0))) "amplitude envelope [GEN table]"
; @PARAM 9 "jta" number 0.1 "jitter amp [0-1, % of max amp+compensation]"
; @PARAM 10 "tra" number 0.1 "tremolo amp [0-1, % of max amp]"
; @PARAM 11 "trf" number 5.0 "tremolo freq [Hz]"
; @PARAM 12 "jtv" number 0.5 "vibrato/jitter panpot [0 = all vibrato, 1 = all jitter]"
; @PARAM 13 "vfq" number 6.0 "vibrato freq [Hz]"
; @PARAM 14 "fdev" number 1.0 "freq deviation [semitones]"
; @PARAM 15 "fenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (1 1) (2 0)) :size 65537 :decimals 3) "frequency envelope [GEN]"
; @PARAM 16 "plow" number -1.0 "lowest (minimum) portamento [semitones]"
; @PARAM 17 "pup" number 0.0 "upper (maximum) portamento amplitude [semitones]"
; @PARAM 18 "penv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "portamento envelope [GEN]"
; @PARAM 19 "pdur" number 0.1 "portamento duration [sec]"
; @PARAM 20 "afil" number 1 "audio function [GEN] (1=sine)"
;
; COMPULSORY GEN FUNCTIONS :
; @GEN f1 0 65537 10 1   ; audio wave (sine)
; @GEN f2 0 65537 10 1   ; vibrato wave (sine)
; @GEN f3 0 65537 10 1   ; tremolo wave (sine)
;-----------------------------------------------------------------------------

...
;	p15	= final beginning of loop [sec]
;	p16	= initial end of loop [sec]
;	p17	= final end of loop [sec]
;	p18	= initial crossfade length [sec]
...
;	lpbeg/end/xf/beg1/end1/xf1	lpmode
	0.1 0.3 0.1 0.5 0.8 0.15	0
s 11
; with santuri
;         amp  f0mn/mx/ev/jt/dr		jta	file	skip aenv
i1	0 10.0 0.0 1.0 2.0 6 0.1 10.0 	0.1	32		0.0  8 \
;	lpbeg/end/beg1/end1/xf/xf1/env/mode
	0.1 0.3 0.5 0.8 0.2 0.3		0
s 11
i1	0 10.0 0.0 1.0 2.0 6 0.1 10.0 	0.1	31		0.0  9 \
;	lpbeg/end/xf/beg1/end1/xf1	lpmode
	0.1 0.2 0.1 0.5 0.6 0.1	0
s 11
i1	0 10.0 0.0 1.0 2.0 6 0.1 10.0 	0.1	32		0.0  9 \
;	lpbeg/end/xf/beg1/end1/xf1	lpmode
	0.1 0.2 0.1 0.5 0.6 0.1	0
s 11
i1	0 10.0 0.0 1.0 2.0 6 0.1 10.0 	0.1	32		0.0  9 \
;	lpbeg/end/xf/beg1/end1/xf1	lpmode
	0.1 0.2 0.1 0.5 0.6 0.1	2
e
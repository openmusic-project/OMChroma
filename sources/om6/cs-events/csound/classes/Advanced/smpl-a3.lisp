...
;    ATTENTION: A GLOBAL SLOT SHOULD NOT HAVE AN INITARG
   ...
   ( numchan :initform (or (get-orc-channels (get-orc "smpl-a3")) 1)
             :allocation :class  :accessor numchan)
   (cs-inits :initform (get-cs-inits (get-orc "smpl-a3")) 
...
;	F0DUR  	: envelope's duration for the transposition factor [sec] (1.0, if=0, use p3)
;	JTA 	: jitter amp for maxamp [0-1] (0.5)
;	AFIL	: file name [GEN01] (santuri.aiff)
;	SKIP	: starting point in the file [sec, >=0] (0.0)

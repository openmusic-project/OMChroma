...
;	BZL 	:	lowest frequency in the buzz [Hz] (440.0)
;	BZH 	:	highest frequency [Hz] (8800.0)
;	BZM 	:	multiplier in the series of amp coeff [float] (0.9)
;	BZMENV	:	function number for the buzz multiplier [GEN] (triangle)
;*****************************************************************************

  ...
  (
   (source-code :initform
                 (load-buffer-textfile
                  (get-orc-source (get-orc "8Ch-2" :local))
                  'textfile "append")
                 :allocation :class :type textfile :accessor source-code)
   (numchan :initform (or (get-orc-channels (get-orc "8Ch-2")) 2) :allocation :class  :accessor numchan)
   (globals-list :initform (get-orc-globals (get-orc "8Ch-2")) :allocation :class :type list :accessor globals-list)

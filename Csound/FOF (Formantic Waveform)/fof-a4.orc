...
; @PARAM 7 "f0env" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "fundamental freq envelope [GEN]"
...
; @PARAM 11 "fqenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "formant freq envelope [GEN]"
...
; @PARAM 15 "bwenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "bandwidth envelope [GEN]"
; @PARAM 16 "aenv" cr::cs-table (:cs-table cr::gen07 :points ((0 1) (65536 1))) "amplitude envelope [GEN]"
; @PARAM 17 "win" number 0.003 "min rise time of the FOF [sec]"
; @PARAM 18 "winmax" number 0.1 "max rise time of the FOF [sec]"
; @PARAM 19 "winenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "envelope of the rise time of the FOF [GEN]"
; @PARAM 20 "wdur" number 0.1 "min duration of the FOF [sec]"
; @PARAM 21 "wdurmax" number 1.0 "max duration of the FOF [sec]"
; @PARAM 22 "wdurenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "envelope of the duration of the FOF [GEN]"
; @PARAM 23 "wout" number 0.02 "min decay of the FOF [sec]"
; @PARAM 24 "woutmax" number 0.2 "max decay of the FOF [sec]"
; @PARAM 25 "woutenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "envelope of the decay of the FOF [GEN]"
; @PARAM 26 "oct" number 0.0 "min octaviation factor [=>0]"
; @PARAM 27 "octmax" number 1.0 "max octaviation factor [=>0]"
; @PARAM 28 "octenv" cr::cs-table (:cs-table cr::gen07 :points ((0 0) (65536 1))) "octaviation factor envelope [GEN]"

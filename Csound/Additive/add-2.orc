...
; @PARAM 6 "atk" number 0.003 "attack time of the amp envlp [sec]"
; @PARAM 7 "dec" number 0.01 "decay time of the amp envlp [sec]"
; @PARAM 8 "scal" number 1.0 "spectral scaler for the fund freq"
; @PARAM 9 "jta" number 0.02 "% of jitter (low-freq random freq variation) [0-1]"
; @PARAM 10 "jtf" number 10.0 "frequency of the jitter [Hz]"
;
; COMPULSORY GEN FUNCTIONS :
; @GEN f1 0 65537 10 1
;-----------------------------------------------------------------------------

...
;		  [0=1, =2, =3, 180/-180=4, 240/-120=5, 300/-60=6]
...
; PANNING BEG
if ((isp_bal >= 0.0) && (isp_bal < 60.0)) goto quad1

if ((isp_bal >= 60.0) && (isp_bal < 120.0)) goto quad2

if ((isp_bal >= 120.0) && (isp_bal < 180.0)) goto quad3

if ((isp_bal >= 180.0) && (isp_bal < 240.0)) goto quad4

if ((isp_bal >= 240.0) && (isp_bal < 300.0)) goto quad5

if ((isp_bal >= 300.0) && (isp_bal < 360.0)) goto quad6

quad1:
aut1, aut2	pan2	asound, ((isp_bal % 60.0) / 60.0)
goto end

quad2:
aut2, aut3	pan2	asound, ((isp_bal % 60.0) / 60.0)
goto end

quad3:
aut3, aut4	pan2	asound, ((isp_bal % 60.0) / 60.0)
goto end

quad4:
aut4, aut5	pan2	asound, ((isp_bal % 60.0) / 60.0)
goto end

quad5:
aut5, aut6	pan2	asound, ((isp_bal % 60.0) / 60.0)
goto end

quad6:
aut6, aut1	pan2	asound, ((isp_bal % 60.0) / 60.0)

end:
         outc     aut1, aut2, aut3, aut4, aut5, aut6
